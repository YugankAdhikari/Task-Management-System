...
export default function Login() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center overflow-hidden bg-black">
      ...
      {/* Content */}
      <form onSubmit={handleLogin} className="relative w-full max-w-md px-4 animate-slide-up">
        ...
        <div className="backdrop-blur-2xl bg-white/3 border border-pink-500/30 rounded-2xl p-8 shadow-2xl animate-pulse-border">
          {/* Animated Title */}
          <h1 className="text-4xl font-bold text-white mb-2 text-center bg-gradient-to-r from-white to-pink-300 bg-clip-text text-transparent">Welcome Back</h1>
          <p className="text-center text-gray-400 text-sm mb-8 animate-slide-up" style={{ animationDelay: '0.1s' }}>Sign in to your account</p>
          ...
          {/* Register Link */}
          <p className="text-center text-gray-500 text-sm animate-slide-up" style={{ animationDelay: '0.5s' }}>
